    ...
    _createClass(SuperRepo, [{
        ...
        value: function getDataUpToDateStatus() {
            ...
            var _config2 = this.config,
                name = _config2.name,
                outOfDateAfter = _config2.outOfDateAfter;


            return new Promise(function (_resolve) {
                _this6.storage.get(name).then(function (_localStore) {
                    ...
                    if (isDataMissing) {
                        ...
                        var isLimitExceeded = new Date().valueOf() - lastFetched > outOfDateAfter;
        ...
        value: function initSyncer() {
            ...
            var outOfDateAfter = this.config.outOfDateAfter;
            ...
            return new Promise(function (_resolve) {
                _this12.getDataUpToDateStatus().then(function (_res) {
                     ...
                     */
                    if (_res.isDataUpToDate) {
                        var diff = new Date().valueOf() - _res.lastFetched;
                        var remainingTime = outOfDateAfter - diff;
                        ...
                        setTimeout(function () {
                            ...
                            _this12.syncInterval = _this12._initSyncInterval(outOfDateAfter);
